...
The input file is assumed to be in ./advent-questions/2023/<day>-<puzzle>.txt.  To change this provide the file path as the last argument
...
`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(args) > 2 {
			...
			file = filepath.Join(currentDir, "advent-questions", "2023", fmt.Sprintf("%s.txt", lookup))
		}
